 ...
 * 
 * #jws exception.ex02.AgentSendingToWrongAddressWithoutWarnings jws#
 * 
 */

public class AgentSendingToWrongAddressWithoutWarnings extends Agent {
	...
	public static void main(String[] argss) {
		new Madkit(Option.launchAgents.toString(), AgentSendingToWrongAddressWithoutWarnings.class.getName() + ",false,1;" + AgentReceiver.class.getName() + ",false,1;" );
	}
}
